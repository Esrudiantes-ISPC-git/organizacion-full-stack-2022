...
constraint fk_fp1_1 foreign key (per_1_1) references MiPerfil (per_1)
);
...
constraint fk_fv1_1 foreign key (vid_1_1) references MiBanda (per_2)
);
...
constraint fk_p_2_3 foreign key (per_2_3) references MiBanda (per_2),
constraint fk_p_1_3 foreign key (per_1_3) references MiPerfil (per_1)
);
...
per_1_2 int,
per_2_1 int,
constraint fk_p_1_2 foreign key (per_1_2) references MiPerfil (per_1),
constraint fk_p_2_1 foreign key (per_2_1) references MiBanda (per_2)
);

select * from Per1_Per2;
...
per_2_2 int,
vid_1_1 int,
constraint fk_p_2_2 foreign key (per_2_2) references MiBanda (per_2),
...
constraint fk_p_1_4 foreign key (per_1_4) references MiPerfil (per_1)
);
...
constraint fk_p_1_5 foreign key (per_1_5) references MiPerfil (per_1)
);
...
constraint fk_p_2_4 foreign key (per_2_4) references MiBanda (per_2)
)
